<template>
	 <view class="contianer">
	        ...
	        <view class="content">
	            ...
	            <view class="bandmini">
	                莫等闲隐私权保护声明是本网站保护用户个人隐私的承诺。鉴于网络的特性，本网站将无可避免地与您产生直接或间接的互动关系，故特此说明本网站对用户个人信息的收集、使用和保护政策，请您务必仔细阅读：
	            </view>
	            ...
	            <view class="bandmini">
	                ...
	                2.1 当您在莫等闲进行用户注册登记、购票、订票、享受送票服务、竞价议价交易或参与公共论坛等活动时，在您的同意及确认下，本网站将通过注册表格、订单等形式要求您提供一些个人资料。这些个人资料包括：
	            </view>
	            ...
	            <view class="bandmini">
	                4.2 针对以上权利，本网站为您提供相关服务，您可以发送电子邮件至：webmaster@piao.com.cn
	            </view>
	            ...
	            <view class="band">
	                7、 莫等闲为您提供个人空间、博客、发表评论等服务。在这些区域内，您公布的任何信息都会成为公开的信息。因此，我们提醒并请您慎重考虑是否有必要在这些区域公开您的个人信息。
	            </view>
	            ...
	            <view class="bandmini">
	                8.2 任何由于计算机2000年问题、黑客政击、计算机病毒侵入或发作、因政府管制而造成的暂时性关闭等影响网络正常经营之不可抗力而造成的个人资料泄露、丢失、被盗用或被窜改等。
	            </view>
